...
// share one block on disjoint chips, and candidates preferring already-fragmented
// blocks come first so partial tiles concentrate dirt instead of fragmenting
// idle blocks. Communication legality is DOR-tolerant: seams that cannot
