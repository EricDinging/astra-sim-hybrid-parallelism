...
// Corrected R3 (RDCN model, 2026-07-21): with ocs_enabled, a cross-block
...
// default (no-OCS, folding-only mode) keeps opposite-face-only pairing.
TEST(BlockModelScatter, PolarityFreeCrossBlockPairs) {
    BlockModel strict({8, 8, 8}, {4, 4, 4});
    BlockModel relaxed({8, 8, 8}, {4, 4, 4}, /*ocs_enabled=*/true);
